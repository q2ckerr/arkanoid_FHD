...
from arkanoid.rounds.round31 import Round31
...
LAYOUT = [
    ...
    ['yellow', 'pink', 'blue', 'red', 'green', 'teal', None, None, None, None, None, None, None],
    ['yellow', 'pink', 'blue', 'red', 'green', 'teal', 'orange', 'white', None, None, None, None, None],
    ['yellow', 'pink', 'blue', 'red', 'green', 'teal', 'orange', 'white', 'yellow', 'pink', None, None, None],
    ['silver', 'pink', 'blue', 'red', 'green', 'teal', 'orange', 'white', 'yellow', 'pink', 'blue', 'red', None],
    [None, 'gold', 'silver', 'red', 'green', 'teal', 'orange', 'white', 'yellow', 'pink', 'blue', 'red', 'green'],
    [None, None, None, 'gold', 'silver', 'teal', 'orange', 'white', 'yellow', 'pink', 'blue', 'red', 'green'],
...
POWERUPS = {
    (0, 0): LaserPowerUp, (12, 6): ExpandPowerUp,
    (6, 3): CatchPowerUp, (9, 4): DuplicatePowerUp,
    (2, 1): ExtraLifePowerUp, (11, 11): SlowBallPowerUp,
}


class Round30(BaseRound):
    _TOP_ROW_START = 0

    def __init__(self, top_offset):
        super().__init__(top_offset)
        self.name = 'Round 30'
        self.next_round = Round31
